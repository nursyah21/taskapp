...
Check performed at Fri May 20 21:38:44 WIB 2022      </nav>
    </div>
  </header>
...
<span class="location"><a href="../../src/main/AndroidManifest.xml">../../src/main/AndroidManifest.xml</a>:5</span>: <span class="message">WRITE_EXTERNAL_STORAGE no longer provides write access when targeting Android 10+</span><br /><pre class="errorlines">
<span class="lineno">  2 </span>  <span class="prefix">xmlns:</span><span class="attribute">android</span>=<span class="value">"http://schemas.android.com/apk/res/android"</span>
...
<span class="lineno">  4 </span>  <span class="tag">&lt;uses-permission</span><span class="attribute"> </span><span class="prefix">android:</span><span class="attribute">name</span>=<span class="value">"android.permission.INTERNET"</span>/>
<span class="caretline"><span class="lineno">  5 </span>  <span class="tag">&lt;uses-permission</span><span class="attribute"> </span><span class="prefix">android:</span><span class="attribute">name</span>=<span class="value">"</span><span class="warning"><span class="value">android.permission.WRITE_EXTERNAL_STORAGE</span></span><span class="value">"</span>/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  6 </span>  <span class="tag">&lt;uses-permission</span><span class="attribute"> </span><span class="prefix">android:</span><span class="attribute">name</span>=<span class="value">"android.permission.READ_EXTERNAL_STORAGE"</span> />
<span class="lineno">  7 </span>  <span class="tag">&lt;application></span>
<span class="lineno">  8 </span>      <span class="tag">&lt;provider</span><span class="attribute"> </span><span class="prefix">tools:</span><span class="attribute">replace</span>=<span class="value">"android:authorities"</span> <span class="prefix">android:</span><span class="attribute">name</span>=<span class="value">".FileSystemFileProvider"</span> <span class="prefix">android:</span><span class="attribute">authorities</span>=<span class="value">"${applicationId}.FileSystemFileProvider"</span> <span class="prefix">android:</span><span class="attribute">exported</span>=<span class="value">"false"</span> <span class="prefix">android:</span><span class="attribute">grantUriPermissions</span>=<span class="value">"true"</span>>
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:91</span>: <span class="message">A newer version of commons-codec:commons-codec than 1.10 is available: 1.11</span><br /><pre class="errorlines">
<span class="lineno">  88 </span>dependencies {
<span class="lineno">  89 </span>  implementation project(<span class="string">':expo-modules-core'</span>)
<span class="lineno">  90 </span>
<span class="caretline"><span class="lineno">  91 </span>  api <span class="warning"><span class="string">'commons-codec:commons-codec:1.10'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  92 </span>  api <span class="string">'commons-io:commons-io:1.4'</span>
<span class="lineno">  93 </span>  api <span class="string">'com.squareup.okhttp3:okhttp:4.9.2'</span>
<span class="lineno">  94 </span>  api <span class="string">'com.squareup.okhttp3:okhttp-urlconnection:4.9.2'</span></pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:92</span>: <span class="message">A newer version of commons-io:commons-io than 1.4 is available: 2.4</span><br /><pre class="errorlines">
<span class="lineno">  89 </span>  implementation project(<span class="string">':expo-modules-core'</span>)
<span class="lineno">  90 </span>
<span class="lineno">  91 </span>  api <span class="string">'commons-codec:commons-codec:1.10'</span>
<span class="caretline"><span class="lineno">  92 </span>  api <span class="warning"><span class="string">'commons-io:commons-io:1.4'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  93 </span>  api <span class="string">'com.squareup.okhttp3:okhttp:4.9.2'</span>
<span class="lineno">  94 </span>  api <span class="string">'com.squareup.okhttp3:okhttp-urlconnection:4.9.2'</span>
<span class="lineno">  95 </span>  api <span class="string">'com.squareup.okio:okio:2.9.0'</span></pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:98</span>: <span class="message">A newer version of org.jetbrains.kotlin:kotlin-stdlib-jdk7 than 1.6.10 is available: 1.6.21</span><br /><pre class="errorlines">
<span class="lineno">  95 </span>  api <span class="string">'com.squareup.okio:okio:2.9.0'</span>
<span class="lineno">  96 </span>  api <span class="string">"androidx.legacy:legacy-support-v4:1.0.0"</span>
<span class="lineno">  97 </span>
<span class="caretline"><span class="lineno">  98 </span>  implementation <span class="warning"><span class="string">"org.jetbrains.kotlin:kotlin-stdlib-jdk7:${getKotlinVersion()}"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/expo/modules/filesystem/FileSystemModule.kt">../../src/main/java/expo/modules/filesystem/FileSystemModule.kt</a>:1101</span>: <span class="message">This <code>AsyncTask</code> class should be static or leaks might occur (expo.modules.filesystem.FileSystemModule.DownloadResumableTask)</span><br /><pre class="errorlines">
<span class="lineno"> 1098 </span>
<span class="lineno"> 1099 </span>  override <span class="keyword">fun</span> onNewIntent(intent: Intent) = Unit
<span class="lineno"> 1100 </span>  private <span class="keyword">class</span> DownloadResumableTaskParams internal constructor(<span class="keyword">var</span> options: Map&lt;String?, Any?>?, <span class="keyword">var</span> call: Call, <span class="keyword">var</span> file: File, <span class="keyword">var</span> isResume: Boolean, <span class="keyword">var</span> promise: Promise)
<span class="caretline"><span class="lineno"> 1101 </span>  private inner <span class="keyword">class</span> <span class="warning">DownloadResumableTask</span> : AsyncTask&lt;DownloadResumableTaskParams?, Void?, Void?>() {</span>
<span class="lineno"> 1102 </span>    override <span class="keyword">fun</span> doInBackground(vararg params: DownloadResumableTaskParams?): Void? {
<span class="lineno"> 1103 </span>      <span class="keyword">val</span> call = params[<span class="number">0</span>]?.call
<span class="lineno"> 1104 </span>      <span class="keyword">val</span> promise = params[<span class="number">0</span>]?.promise
</pre>
