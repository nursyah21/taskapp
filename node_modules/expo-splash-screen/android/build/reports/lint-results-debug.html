...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      <span class="mdl-layout-title">Lint Report: 17 warnings</span>
      <div class="mdl-layout-spacer"></div>
      <nav class="mdl-navigation mdl-layout--large-screen-only">
Check performed at Fri May 20 21:38:46 WIB 2022      </nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#CustomSplashScreen"><i class="material-icons warning-icon">warning</i>Application-defined Launch Screen (11)</a>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/expo/modules/splashscreen/NativeResourcesBasedSplashScreenViewProvider.kt">../../src/main/java/expo/modules/splashscreen/NativeResourcesBasedSplashScreenViewProvider.kt</a>:16</span>: <span class="message">The application should not provide its own launch screen</span><br /><pre class="errorlines">
<span class="lineno"> 13 </span><span class="javadoc">/**
</span><span class="lineno"> 14 </span><span class="javadoc"> * Default implementation that uses native resources.
</span><span class="lineno"> 15 </span><span class="javadoc"> */</span>
<span class="caretline"><span class="lineno"> 16 </span><span class="keyword">class</span> <span class="warning">NativeResourcesBasedSplashScreenViewProvider</span>(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 17 </span>  private <span class="keyword">val</span> resizeMode: SplashScreenImageResizeMode
<span class="lineno"> 18 </span>) : SplashScreenViewProvider {
</pre>

<span class="location"><a href="../../src/main/java/expo/modules/splashscreen/singletons/SplashScreen.kt">../../src/main/java/expo/modules/splashscreen/singletons/SplashScreen.kt</a>:10</span>: <span class="message">The application should not provide its own launch screen</span><br /><pre class="errorlines">
<span class="lineno">   7 </span>import expo.modules.core.interfaces.SingletonModule
<span class="lineno">   8 </span>import java.util.*
<span class="lineno">   9 </span>
<span class="caretline"><span class="lineno">  10 </span><span class="keyword">object</span> <span class="warning">SplashScreen</span> : SingletonModule {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  11 </span>  private const <span class="keyword">val</span> TAG = <span class="string">"SplashScreen"</span>
<span class="lineno">  12 </span>
<span class="lineno">  13 </span>  override <span class="keyword">fun</span> getName(): String {
</pre>

<span class="location"><a href="../../src/main/java/expo/modules/splashscreen/SplashScreenImageResizeMode.kt">../../src/main/java/expo/modules/splashscreen/SplashScreenImageResizeMode.kt</a>:5</span>: <span class="message">The application should not provide its own launch screen</span><br /><pre class="errorlines">
<span class="lineno">  2 </span>
<span class="lineno">  3 </span>import android.widget.ImageView
<span class="lineno">  4 </span>
<span class="caretline"><span class="lineno">  5 </span>enum <span class="keyword">class</span> <span class="warning">SplashScreenImageResizeMode</span>(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  6 </span>  <span class="keyword">val</span> scaleType: ImageView.ScaleType,
<span class="lineno">  7 </span>  private <span class="keyword">val</span> resizeMode: String
<span class="lineno">  8 </span>) {
</pre>

<span class="location"><a href="../../src/main/java/expo/modules/splashscreen/SplashScreenModule.kt">../../src/main/java/expo/modules/splashscreen/SplashScreenModule.kt</a>:18</span>: <span class="message">The application should not provide its own launch screen</span><br /><pre class="errorlines">
<span class="lineno"> 15 </span><span class="comment">// in versioned SplashScreen kotlin object that stores no information about the ExperienceActivity.</span>
<span class="lineno"> 16 </span>import expo.modules.splashscreen.singletons.SplashScreen
<span class="lineno"> 17 </span>
<span class="caretline"><span class="lineno"> 18 </span><span class="keyword">class</span> <span class="warning">SplashScreenModule</span>(context: Context) : ExportedModule(context) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 19 </span>  companion <span class="keyword">object</span> {
<span class="lineno"> 20 </span>    private const <span class="keyword">val</span> NAME = <span class="string">"ExpoSplashScreen"</span>
<span class="lineno"> 21 </span>    private const <span class="keyword">val</span> ERROR_TAG = <span class="string">"ERR_SPLASH_SCREEN"</span></pre>

<span class="location"><a href="../../src/main/java/expo/modules/splashscreen/SplashScreenPackage.kt">../../src/main/java/expo/modules/splashscreen/SplashScreenPackage.kt</a>:10</span>: <span class="message">The application should not provide its own launch screen</span><br /><pre class="errorlines">
<span class="lineno">  7 </span>import expo.modules.core.interfaces.ReactActivityLifecycleListener
<span class="lineno">  8 </span>import expo.modules.core.interfaces.SingletonModule
<span class="lineno">  9 </span>
<span class="caretline"><span class="lineno"> 10 </span><span class="keyword">class</span> <span class="warning">SplashScreenPackage</span> : BasePackage() {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 11 </span>  override <span class="keyword">fun</span> createExportedModules(context: Context): List&lt;ExportedModule> {
<span class="lineno"> 12 </span>    <span class="keyword">return</span> listOf(SplashScreenModule(context))
<span class="lineno"> 13 </span>  }
</pre>

<button class="mdl-button mdl-js-button mdl-button--primary" id="CustomSplashScreenDivLink" onclick="reveal('CustomSplashScreenDiv');" />+ 6 More Occurrences...</button>
<div id="CustomSplashScreenDiv" style="display: none">
<span class="location"><a href="../../src/main/java/expo/modules/splashscreen/SplashScreenReactActivityLifecycleListener.kt">../../src/main/java/expo/modules/splashscreen/SplashScreenReactActivityLifecycleListener.kt</a>:17</span>: <span class="message">The application should not provide its own launch screen</span><br /><pre class="errorlines">
<span class="lineno"> 14 </span><span class="comment">// EXPO_VERSIONING_NEEDS_EXPOVIEW_R</span>
<span class="lineno"> 15 </span><span class="comment">/* ktlint-enable no-unused-imports */</span>
<span class="lineno"> 16 </span>
<span class="caretline"><span class="lineno"> 17 </span><span class="keyword">class</span> <span class="warning">SplashScreenReactActivityLifecycleListener</span>(activityContext: Context) : ReactActivityLifecycleListener {</span>
<span class="lineno"> 18 </span>  override <span class="keyword">fun</span> onCreate(activity: Activity, savedInstanceState: Bundle?) {
<span class="lineno"> 19 </span>    <span class="comment">// To support backward compatible or SplashScreenImageResizeMode customization</span>
<span class="lineno"> 20 </span>    <span class="comment">// that calling `SplashScreen.show()` in MainActivity,</span></pre>

<span class="location"><a href="../../src/main/java/expo/modules/splashscreen/singletons/SplashScreenStatusBar.kt">../../src/main/java/expo/modules/splashscreen/singletons/SplashScreenStatusBar.kt</a>:8</span>: <span class="message">The application should not provide its own launch screen</span><br /><pre class="errorlines">
<span class="lineno">  5 </span>import android.os.Build
<span class="lineno">  6 </span>import androidx.core.view.ViewCompat
<span class="lineno">  7 </span>
<span class="caretline"><span class="lineno">  8 </span><span class="keyword">object</span> <span class="warning">SplashScreenStatusBar</span> {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  9 </span>  <span class="keyword">fun</span> configureTranslucent(activity: Activity, translucent: Boolean?) {
<span class="lineno"> 10 </span>    <span class="annotation">@SuppressLint</span>(<span class="string">"ObsoleteSdkInt"</span>)
<span class="lineno"> 11 </span>    <span class="keyword">if</span> (Build.VERSION.SDK_INT &lt; Build.VERSION_CODES.LOLLIPOP) {
</pre>
...
<span class="location"><a href="../../src/main/java/expo/modules/splashscreen/SplashScreenViewController.kt">../../src/main/java/expo/modules/splashscreen/SplashScreenViewController.kt</a></span>: <span class="message">The application should not provide its own launch screen</span><br />
<span class="location"><a href="../../src/main/java/expo/modules/splashscreen/SplashScreenViewController.kt">../../src/main/java/expo/modules/splashscreen/SplashScreenViewController.kt</a>:12</span>: <span class="message">The application should not provide its own launch screen</span><br /><pre class="errorlines">
<span class="lineno">   9 </span>
<span class="lineno">  10 </span>const <span class="keyword">val</span> SEARCH_FOR_ROOT_VIEW_INTERVAL = <span class="number">20L</span>
<span class="lineno">  11 </span>
<span class="caretline"><span class="lineno">  12 </span>open <span class="keyword">class</span> <span class="warning">SplashScreenViewController</span>(&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  13 </span>  activity: Activity,
<span class="lineno">  14 </span>  private <span class="keyword">val</span> rootViewClass: Class&lt;out ViewGroup>,
<span class="lineno">  15 </span>  private <span class="keyword">val</span> splashScreenView: View
</pre>

<span class="location"><a href="../../src/main/java/expo/modules/splashscreen/SplashScreenViewProvider.kt">../../src/main/java/expo/modules/splashscreen/SplashScreenViewProvider.kt</a>:9</span>: <span class="message">The application should not provide its own launch screen</span><br /><pre class="errorlines">
<span class="lineno">  6 </span><span class="javadoc">/**
</span><span class="lineno">  7 </span><span class="javadoc"> * This interface is responsible for providing properly configured SplashScreenView.
</span><span class="lineno">  8 </span><span class="javadoc"> */</span>
<span class="caretline"><span class="lineno">  9 </span><span class="keyword">interface</span> <span class="warning">SplashScreenViewProvider</span> {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 10 </span>  <span class="keyword">fun</span> createSplashScreenView(context: Context): View
<span class="lineno"> 11 </span>}
</pre>
...
Starting in Android 12 (API 31+), the application's Launch Screen is provided by the system and the application should not create its own, otherwise the user will see two splashscreen. Please check the <code>SplashScreen</code> class to check how the Splash Screen can be controlled and customized.<br/>To suppress this error, use the issue id "CustomSplashScreen" as explained in the <a href="#SuppressInfo">Suppressing Warnings and Errors</a> section.<br/>
<br/></div>
</div>
</div>
<div class="chips">
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:89</span>: <span class="message">A newer version of androidx.appcompat:appcompat than 1.2.0 is available: 1.4.1</span><br /><pre class="errorlines">
<span class="lineno"> 86 </span>
<span class="lineno"> 87 </span>  <span class="comment">//noinspection GradleDynamicVersion</span>
<span class="lineno"> 88 </span>  implementation <span class="string">'com.facebook.react:react-native:+'</span>
<span class="caretline"><span class="lineno"> 89 </span>  implementation <span class="warning"><span class="string">'androidx.appcompat:appcompat:1.2.0'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 90 </span>  implementation <span class="string">"org.jetbrains.kotlin:kotlin-stdlib-jdk7:${getKotlinVersion()}"</span>
<span class="lineno"> 91 </span>  implementation <span class="string">"org.jetbrains.kotlin:kotlin-reflect:${getKotlinVersion()}"</span>
<span class="lineno"> 92 </span>}
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:90</span>: <span class="message">A newer version of org.jetbrains.kotlin:kotlin-stdlib-jdk7 than 1.6.10 is available: 1.6.21</span><br /><pre class="errorlines">
<span class="lineno"> 87 </span>  <span class="comment">//noinspection GradleDynamicVersion</span>
<span class="lineno"> 88 </span>  implementation <span class="string">'com.facebook.react:react-native:+'</span>
<span class="lineno"> 89 </span>  implementation <span class="string">'androidx.appcompat:appcompat:1.2.0'</span>
<span class="caretline"><span class="lineno"> 90 </span>  implementation <span class="warning"><span class="string">"org.jetbrains.kotlin:kotlin-stdlib-jdk7:${getKotlinVersion()}"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 91 </span>  implementation <span class="string">"org.jetbrains.kotlin:kotlin-reflect:${getKotlinVersion()}"</span>
<span class="lineno"> 92 </span>}
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:91</span>: <span class="message">A newer version of org.jetbrains.kotlin:kotlin-reflect than 1.6.10 is available: 1.6.21</span><br /><pre class="errorlines">
<span class="lineno"> 88 </span>  implementation <span class="string">'com.facebook.react:react-native:+'</span>
<span class="lineno"> 89 </span>  implementation <span class="string">'androidx.appcompat:appcompat:1.2.0'</span>
<span class="lineno"> 90 </span>  implementation <span class="string">"org.jetbrains.kotlin:kotlin-stdlib-jdk7:${getKotlinVersion()}"</span>
<span class="caretline"><span class="lineno"> 91 </span>  implementation <span class="warning"><span class="string">"org.jetbrains.kotlin:kotlin-reflect:${getKotlinVersion()}"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 92 </span>}
</pre>
...
<div class="issue">
<div class="id">MediaCapabilities<div class="issueSeparator"></div>
</div>
<div class="metadata">Disabled By: Default<br/>
<div class="explanation">
In Android 12 and higher, an app that opens media files should explicitly specify media formats that it doesn't support, so the OS can provide a transcoded file instead.<br/>To suppress this error, use the issue id "MediaCapabilities" as explained in the <a href="#SuppressInfo">Suppressing Warnings and Errors</a> section.<br/>
<br/></div>
</div>
</div>
<div class="issue">
