...
Check performed at Fri May 20 21:37:38 WIB 2022      </nav>
    </div>
  </header>
...
<span class="location"><a href="../../src/main/java/expo/modules/ReactActivityDelegateWrapper.kt">../../src/main/java/expo/modules/ReactActivityDelegateWrapper.kt</a>:91</span>: <span class="message">Reflective access to accessFlags, which is not part of the public SDK and therefore likely to change in future Android releases</span><br /><pre class="errorlines">
<span class="lineno">  88 </span>    <span class="keyword">if</span> (newDelegate != <span class="keyword">null</span> &amp;&amp; newDelegate != <span class="keyword">this</span>) {
<span class="lineno">  89 </span>      <span class="keyword">val</span> mDelegateField = ReactActivity::<span class="keyword">class</span>.java.getDeclaredField(<span class="string">"mDelegate"</span>)
<span class="lineno">  90 </span>      mDelegateField.isAccessible = <span class="keyword">true</span>
<span class="caretline"><span class="lineno">  91 </span>      <span class="keyword">val</span> modifiers = <span class="warning">Field::<span class="keyword">class</span>.java.getDeclaredField(<span class="string">"accessFlags"</span>)</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  92 </span>      modifiers.isAccessible = <span class="keyword">true</span>
<span class="lineno">  93 </span>      modifiers.setInt(mDelegateField, mDelegateField.modifiers and Modifier.FINAL.inv())
<span class="lineno">  94 </span>      mDelegateField.set(activity, newDelegate)
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:137</span>: <span class="message">A newer version of junit:junit than 4.13.1 is available: 4.13.2</span><br /><pre class="errorlines">
<span class="lineno"> 134 </span>  <span class="comment">//noinspection GradleDynamicVersion</span>
<span class="lineno"> 135 </span>  implementation <span class="string">'com.facebook.react:react-native:+'</span>
<span class="lineno"> 136 </span>
<span class="caretline"><span class="lineno"> 137 </span>  testImplementation <span class="warning"><span class="string">'junit:junit:4.13.1'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 138 </span>  testImplementation <span class="string">'androidx.test:core:1.4.0'</span>
<span class="lineno"> 139 </span>  testImplementation <span class="string">"com.google.truth:truth:1.1.2"</span>
<span class="lineno"> 140 </span>  testImplementation <span class="string">'io.mockk:mockk:1.12.0'</span></pre>
