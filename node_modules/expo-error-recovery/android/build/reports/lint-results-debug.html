...
Check performed at Fri May 20 21:38:11 WIB 2022      </nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#ApplySharedPref"><i class="material-icons warning-icon">warning</i>Use <code>apply()</code> on <code>SharedPreferences</code> (2)</a>
...
<span class="location"><a href="../../src/main/java/expo/modules/errorrecovery/ErrorRecoveryModule.kt">../../src/main/java/expo/modules/errorrecovery/ErrorRecoveryModule.kt</a>:31</span>: <span class="message">Consider using <code>apply()</code> instead; <code>commit</code> writes its data to persistent storage immediately, whereas <code>apply</code> will handle it in the background</span><br /><pre class="errorlines">
<span class="lineno"> 28 </span>  }
<span class="lineno"> 29 </span>
<span class="lineno"> 30 </span>  protected open <span class="keyword">fun</span> setRecoveryProps(props: String) {
<span class="caretline"><span class="lineno"> 31 </span>    mSharedPreferences.edit().putString(RECOVERY_STORE_KEY, props).<span class="warning">commit()</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 32 </span>  }
<span class="lineno"> 33 </span>
<span class="lineno"> 34 </span>  protected open <span class="keyword">fun</span> consumeRecoveryProps(): String? {
</pre>

<span class="location"><a href="../../src/main/java/expo/modules/errorrecovery/ErrorRecoveryModule.kt">../../src/main/java/expo/modules/errorrecovery/ErrorRecoveryModule.kt</a>:36</span>: <span class="message">Consider using <code>apply()</code> instead; <code>commit</code> writes its data to persistent storage immediately, whereas <code>apply</code> will handle it in the background</span><br /><pre class="errorlines">
<span class="lineno"> 33 </span>
<span class="lineno"> 34 </span>  protected open <span class="keyword">fun</span> consumeRecoveryProps(): String? {
<span class="lineno"> 35 </span>    <span class="keyword">return</span> mSharedPreferences.getString(RECOVERY_STORE_KEY, <span class="keyword">null</span>)?.let {
<span class="caretline"><span class="lineno"> 36 </span>      mSharedPreferences.edit().remove(RECOVERY_STORE_KEY).<span class="warning">commit()</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 37 </span>      it
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:86</span>: <span class="message">A newer version of org.jetbrains.kotlin:kotlin-stdlib-jdk7 than 1.6.10 is available: 1.6.21</span><br /><pre class="errorlines">
<span class="lineno"> 83 </span>
<span class="lineno"> 84 </span>dependencies {
<span class="lineno"> 85 </span>  implementation project(<span class="string">':expo-modules-core'</span>)
<span class="caretline"><span class="lineno"> 86 </span>  implementation <span class="warning"><span class="string">"org.jetbrains.kotlin:kotlin-stdlib-jdk7:${getKotlinVersion()}"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 87 </span>
<span class="lineno"> 88 </span>  <span class="keyword">if</span> (project.findProject(<span class="string">':expo-modules-test-core'</span>)) {
<span class="lineno"> 89 </span>    testImplementation project(<span class="string">':expo-modules-test-core'</span>)
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:91</span>: <span class="message">A newer version of junit:junit than 4.12 is available: 4.13.2</span><br /><pre class="errorlines">
<span class="lineno"> 88 </span>  <span class="keyword">if</span> (project.findProject(<span class="string">':expo-modules-test-core'</span>)) {
<span class="lineno"> 89 </span>    testImplementation project(<span class="string">':expo-modules-test-core'</span>)
<span class="lineno"> 90 </span>  }
<span class="caretline"><span class="lineno"> 91 </span>  testImplementation <span class="warning"><span class="string">'junit:junit:4.12'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 92 </span>  testImplementation <span class="string">"org.robolectric:robolectric:4.3.1"</span>
<span class="lineno"> 93 </span>}
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:92</span>: <span class="message">A newer version of org.robolectric:robolectric than 4.3.1 is available: 4.5.1</span><br /><pre class="errorlines">
<span class="lineno"> 89 </span>    testImplementation project(<span class="string">':expo-modules-test-core'</span>)
<span class="lineno"> 90 </span>  }
<span class="lineno"> 91 </span>  testImplementation <span class="string">'junit:junit:4.12'</span>
<span class="caretline"><span class="lineno"> 92 </span>  testImplementation <span class="warning"><span class="string">"org.robolectric:robolectric:4.3.1"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 93 </span>}
</pre>
