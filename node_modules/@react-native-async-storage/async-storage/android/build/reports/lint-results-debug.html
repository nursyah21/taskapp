...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      <span class="mdl-layout-title">Lint Report: 6 errors and 8 warnings</span>
      <div class="mdl-layout-spacer"></div>
      <nav class="mdl-navigation mdl-layout--large-screen-only">
Check performed at Fri May 20 21:39:00 WIB 2022      </nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#LongLogTag"><i class="material-icons error-icon">error</i>Too Long Log Tags (6)</a>
...
<span class="location"><a href="../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageExpoMigration.java">../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageExpoMigration.java</a>:34</span>: <span class="message">The logging tag can be at most 23 characters, was 25 (AsyncStorageExpoMigration)</span><br /><pre class="errorlines">
<span class="lineno">  31 </span>        File expoDatabase = getLastModifiedFile(expoDatabases);
<span class="lineno">  32 </span>
<span class="lineno">  33 </span>        <span class="keyword">if</span> (expoDatabase == <span class="keyword">null</span>) {
<span class="caretline"><span class="lineno">  34 </span>            Log.v(<span class="error">LOG_TAG</span>, <span class="string">"No scoped database found"</span>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  35 </span>            <span class="keyword">return</span>;
<span class="lineno">  36 </span>        }
</pre>

<span class="location"><a href="../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageExpoMigration.java">../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageExpoMigration.java</a>:42</span>: <span class="message">The logging tag can be at most 23 characters, was 25 (AsyncStorageExpoMigration)</span><br /><pre class="errorlines">
<span class="lineno">  39 </span>      <span class="comment">// Create the storage file</span>
<span class="lineno">  40 </span>      ReactDatabaseSupplier.getInstance(context).get();
<span class="lineno">  41 </span>      copyFile(<span class="keyword">new</span> FileInputStream(expoDatabase), <span class="keyword">new</span> FileOutputStream(context.getDatabasePath(ReactDatabaseSupplier.DATABASE_NAME)));
<span class="caretline"><span class="lineno">  42 </span>      Log.v(<span class="error">LOG_TAG</span>, <span class="string">"Migrated most recently modified database "</span> + expoDatabase.getName() + <span class="string">" to RKStorage"</span>);</span>
<span class="lineno">  43 </span>  } <span class="keyword">catch</span> (Exception e) {
<span class="lineno">  44 </span>      Log.v(LOG_TAG, <span class="string">"Failed to migrate scoped database "</span> + expoDatabase.getName());
<span class="lineno">  45 </span>      e.printStackTrace();
</pre>

<span class="location"><a href="../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageExpoMigration.java">../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageExpoMigration.java</a>:44</span>: <span class="message">The logging tag can be at most 23 characters, was 25 (AsyncStorageExpoMigration)</span><br /><pre class="errorlines">
<span class="lineno">  41 </span>      copyFile(<span class="keyword">new</span> FileInputStream(expoDatabase), <span class="keyword">new</span> FileOutputStream(context.getDatabasePath(ReactDatabaseSupplier.DATABASE_NAME)));
<span class="lineno">  42 </span>      Log.v(LOG_TAG, <span class="string">"Migrated most recently modified database "</span> + expoDatabase.getName() + <span class="string">" to RKStorage"</span>);
<span class="lineno">  43 </span>  } <span class="keyword">catch</span> (Exception e) {
<span class="caretline"><span class="lineno">  44 </span>      Log.v(<span class="error">LOG_TAG</span>, <span class="string">"Failed to migrate scoped database "</span> + expoDatabase.getName());&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  45 </span>      e.printStackTrace();
<span class="lineno">  46 </span>      <span class="keyword">return</span>;
<span class="lineno">  47 </span>  }
</pre>

<span class="location"><a href="../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageExpoMigration.java">../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageExpoMigration.java</a>:52</span>: <span class="message">The logging tag can be at most 23 characters, was 25 (AsyncStorageExpoMigration)</span><br /><pre class="errorlines">
<span class="lineno">  49 </span>        <span class="keyword">try</span> {
<span class="lineno">  50 </span>            <span class="keyword">for</span> (File file : expoDatabases) {
<span class="lineno">  51 </span>                <span class="keyword">if</span> (file.delete()) {
<span class="caretline"><span class="lineno">  52 </span>                    Log.v(<span class="error">LOG_TAG</span>, <span class="string">"Deleted scoped database "</span> + file.getName());&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  53 </span>                } <span class="keyword">else</span> {
<span class="lineno">  54 </span>                    Log.v(LOG_TAG, <span class="string">"Failed to delete scoped database "</span> + file.getName());
<span class="lineno">  55 </span>                }
</pre>

<span class="location"><a href="../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageExpoMigration.java">../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageExpoMigration.java</a>:54</span>: <span class="message">The logging tag can be at most 23 characters, was 25 (AsyncStorageExpoMigration)</span><br /><pre class="errorlines">
<span class="lineno">  51 </span>                <span class="keyword">if</span> (file.delete()) {
<span class="lineno">  52 </span>                    Log.v(LOG_TAG, <span class="string">"Deleted scoped database "</span> + file.getName());
<span class="lineno">  53 </span>                } <span class="keyword">else</span> {
<span class="caretline"><span class="lineno">  54 </span>                    Log.v(<span class="error">LOG_TAG</span>, <span class="string">"Failed to delete scoped database "</span> + file.getName());&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  55 </span>                }
<span class="lineno">  56 </span>            }
<span class="lineno">  57 </span>        } <span class="keyword">catch</span> (Exception e) {
</pre>

<span class="location"><a href="../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageExpoMigration.java">../../src/main/java/com/reactnativecommunity/asyncstorage/AsyncStorageExpoMigration.java</a>:61</span>: <span class="message">The logging tag can be at most 23 characters, was 25 (AsyncStorageExpoMigration)</span><br /><pre class="errorlines">
<span class="lineno">  58 </span>            e.printStackTrace();
<span class="lineno">  59 </span>        }
<span class="lineno">  60 </span>
<span class="caretline"><span class="lineno">  61 </span>        Log.v(<span class="error">LOG_TAG</span>, <span class="string">"Completed the scoped AsyncStorage migration"</span>);&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  62 </span>    }
<span class="lineno">  63 </span>
<span class="lineno">  64 </span>    <span class="keyword">private</span> <span class="keyword">static</span> <span class="keyword">boolean</span> isAsyncStorageDatabaseCreated(Context context) {
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:50</span>: <span class="message">A newer version of com.android.tools.build:gradle than 4.2.2 is available: 7.2.0</span><br /><pre class="errorlines">
<span class="lineno">  47 </span>    }
<span class="lineno">  48 </span>    dependencies {
<span class="lineno">  49 </span>        <span class="keyword">if</span> (project == rootProject) {
<span class="caretline"><span class="lineno">  50 </span>            <span class="warning">classpath <span class="string">'com.android.tools.build:gradle:4.2.2'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  51 </span>            classpath <span class="string">"org.jetbrains.kotlin:kotlin-gradle-plugin:$asyncStorageKtVersion"</span>
