...
Check performed at Fri May 20 21:38:06 WIB 2022      </nav>
    </div>
  </header>
...
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:87</span>: <span class="message">A newer version of com.android.installreferrer:installreferrer than 1.0 is available: 2.2</span><br /><pre class="errorlines">
...
<span class="caretline"><span class="lineno"> 87 </span>  implementation <span class="warning"><span class="string">'com.android.installreferrer:installreferrer:1.0'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 88 </span>  implementation <span class="string">"org.jetbrains.kotlin:kotlin-stdlib-jdk7:${getKotlinVersion()}"</span>
<span class="lineno"> 89 </span>
<span class="lineno"> 90 </span>  <span class="keyword">if</span> (project.findProject(<span class="string">':expo-modules-test-core'</span>)) {
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:88</span>: <span class="message">A newer version of org.jetbrains.kotlin:kotlin-stdlib-jdk7 than 1.6.10 is available: 1.6.21</span><br /><pre class="errorlines">
<span class="lineno"> 85 </span>  implementation project(<span class="string">':expo-modules-core'</span>)
<span class="lineno"> 86 </span>
<span class="lineno"> 87 </span>  implementation <span class="string">'com.android.installreferrer:installreferrer:1.0'</span>
<span class="caretline"><span class="lineno"> 88 </span>  implementation <span class="warning"><span class="string">"org.jetbrains.kotlin:kotlin-stdlib-jdk7:${getKotlinVersion()}"</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 89 </span>
<span class="lineno"> 90 </span>  <span class="keyword">if</span> (project.findProject(<span class="string">':expo-modules-test-core'</span>)) {
<span class="lineno"> 91 </span>    testImplementation project(<span class="string">':expo-modules-test-core'</span>)
</pre>

<span class="location"><a href="../../build.gradle">../../build.gradle</a>:94</span>: <span class="message">A newer version of junit:junit than 4.12 is available: 4.13.2</span><br /><pre class="errorlines">
<span class="lineno"> 91 </span>    testImplementation project(<span class="string">':expo-modules-test-core'</span>)
<span class="lineno"> 92 </span>  }
<span class="lineno"> 93 </span>  testImplementation <span class="string">"org.robolectric:robolectric:4.5.1"</span>
<span class="caretline"><span class="lineno"> 94 </span>  testImplementation <span class="warning"><span class="string">'junit:junit:4.12'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
